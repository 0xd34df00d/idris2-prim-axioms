...
export
interface VerifiedBits repr => IsModelOf repr prim | prim where
  ...
  homoZeros : Bits prim => prim2repr B.zeroBits = B.zeroBits
  homoZeros = believe_me ()

  homoOnes : Bits prim => prim2repr B.oneBits = B.oneBits
  homoOnes = believe_me ()
